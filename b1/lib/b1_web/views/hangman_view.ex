defmodule B1Web.HangmanView do
  ...
  # alias
  alias B1Web.HangmanView.HangmanHelpers.FigureFor
  ##################################################################
  ...
  def continue_or_try_again(conn, _) do
    # You dont eex <% %> stuff or @ to use the form_for() in this file.
    form_for(
      conn,
  ...
  # delegating the hangman figure from the helper file
